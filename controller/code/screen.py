...
class Screen():
    ...
    def drawAlarm(self, alarm, Y, fontSize, blockSize):
        ...
        with canvas(SCREENDEVICE) as draw:
                ...
                draw.text((W-blockSize-autoStrSize[0], Y+(blockSize-fontSize)/2), autoStr, fill="whi$
                draw.ellipse((W-blockSize+9, Y+5, W-1, Y+blockSize-5), outline="white", fill=activeC$
